...
public class PostBuildTestBundleWarBundleParts {
	
	private static final String EXPECTED_MANIFEST = 
		"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n" + 
		"<manifest xmlns=\"http://www.ibm.com/xmlns/prod/cics/bundle\" bundleMajorVer=\"0\" bundleMicroVer=\"1\" bundleMinorVer=\"0\" bundleRelease=\"0\" bundleVersion=\"1\" id=\"test-bundle-war-bundle-parts\">\n" + 
		"  <meta_directives>\n" + 
		...
		"  <define name=\"test-bundle-war-bundle-parts-0.0.1-SNAPSHOT\" path=\"test-bundle-war-bundle-parts-0.0.1-SNAPSHOT.warbundle\" type=\"http://www.ibm.com/xmlns/prod/cics/bundle/WARBUNDLE\"/>\n" + 
		"</manifest>";
	
	private static final String EXPECTED_BUNDLE_PART = 
		"<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\"?>\n" + 
		"<warbundle jvmserver=\"EYUCMCIJ\" symbolicname=\"test-bundle-war-bundle-parts-0.0.1-SNAPSHOT\"/>";
	
	static void assertOutput(File root) throws Exception {
		assertBundleContents(
			root.toPath().resolve("target/test-bundle-war-bundle-parts-0.0.1-SNAPSHOT-cics-bundle.zip"),
			manifestValidator(EXPECTED_MANIFEST),
			bfv(
				"/test-bundle-war-bundle-parts-0.0.1-SNAPSHOT.warbundle",
				is -> assertThat(is, CompareMatcher.isIdenticalTo(EXPECTED_BUNDLE_PART))
			),
			bfv(
				"/test-bundle-war-bundle-parts-0.0.1-SNAPSHOT.war",
				is -> {}
			),
			bfv(
				"/JAVAVES1.program",
