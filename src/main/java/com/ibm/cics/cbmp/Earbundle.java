...
public class Earbundle extends BundlePart {
	
	private static final String TYPE = CICSBundleMavenPlugin.NS + "/EARBUNDLE";
	...
	public Define writeContent(File workDir, MavenProject project) throws MojoExecutionException {
		//copy ear artifact from dependencies
		...
		try {
			...
			throw new MojoExecutionException("Error copying ear", e);
		}
		...
		String definePath = name + ".earbundle";
